...
public class Welcome extends JFrame
{
    ...
    void initComponents(){
        ...
        c.add(creation);
         JLabel creator1= new JLabel("MD Raihan Khan");
        ...
        creator1.addMouseListener(new MouseAdapter(){
           ...
           Desktop.getDesktop().browse(new URI("https://www.facebook.com/raihankhancs"));
           ...
           creator1.setText("<html><a href=''>MD Raihan Khan</a></html>");
            }
 
           @Override
           public void mouseExited(MouseEvent e) {
           creator1.setText("MD Raihan Khan");
            }
         });

        c.add(creator1);
        
        JLabel creator2= new JLabel("MD Gulam Rahman Ork Babu");
        ...
        creator2.addMouseListener(new MouseAdapter() {
          ...
          Desktop.getDesktop().browse(new URI("https://www.facebook.com/Orkrahman97"));
           ...
           creator2.setText("<html><a href=''>MD Gulam Rahman Ork Babu</a></html>");
            }
 
           @Override
           public void mouseExited(MouseEvent e) {
           creator2.setText("MD GUlam Rahman Ork Babu");
        ...
        website.addMouseListener(new MouseAdapter() {
          ...
          Desktop.getDesktop().browse(new URI("mailto:raihan.khan01@northsouth.edu"));
           ...
           website.setText("<html><a href=''>Please click here</a></html>");
            }
 
           @Override
           public void mouseExited(MouseEvent e) {
           website.setText("Email Us");
            }
         });
        c.add(website);
        ...
        fbgroup.addMouseListener(new MouseAdapter() {
          ...
          Desktop.getDesktop().browse(new URI("https://www.facebook.com/groups/NSUScholars/"));
           ...
           fbgroup.setText("<html><a href=''>NSU Scholars</a></html>");
            }
